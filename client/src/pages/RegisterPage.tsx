                    ...
                    <div className="space-y-6">
                        {step === 1 && (
                            <div className="space-y-6 animate-fade-in">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <KaruppuLogo className="absolute left-4 top-1/2 -translate-y-1/2 text-nova-text-dim" size={18} />
                                        <input
                                            type="password"
                                            name="pin"
                                            maxLength={6}
                        ...
                        {step === 2 && (
                            <div className="space-y-6 animate-fade-in">
                                ...
                                <div>
                                    <label className="block text-[10px] font-black text-nova-text-dim uppercase tracking-[2px] mb-3 ml-2">Security Q3: (DOB Date - Month)</label>
                                    <div className="relative">
